...
describe("termlet.filter", function()
  ...
  describe("apply_filters", function()
    ...
    it("should filter lines from buffer", function()
      local buf = vim.api.nvim_create_buf(false, true)
  ...
  describe("clear_buffer", function()
    it("should clear highlights from buffer", function()
      local buf = vim.api.nvim_create_buf(false, true)
      ...
      local ns_id = filter.get_namespace()
      local extmarks_before = vim.api.nvim_buf_get_extmarks(buf, ns_id, 0, -1, {})
